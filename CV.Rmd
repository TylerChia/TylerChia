...
Undergraduate Research Assistant | UCSB Geography Department | University of California, Santa Barbara

- Using R to characterize hydrologic regions of the U.S. by comparing data from the NOAA National Water Model to USGS streamflow gauges.
...
- UCSB Data Science Club Mentor
- UCSB Resilience Summit and Certificate Program
...
- Analysis: tidyverse, Pandas, Numpy
- Development: RMarkdown, Github, MS Office, Basic Knowledge of HTML and CSS
- Mapping: sf, raster, leaflet, OpenStreetMaps, whitebox, bbox
